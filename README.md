...
DSA Search Engine Link: https://search-engine-for-data-structure-an.vercel.app/


## Description:
This project presents a search engine for Data Structures and Algorithms (DSA) questions. It involves an extensive scraping process, where 2905 problems were extracted from LeetCode using Puppeteer. To ensure the data's cleanliness and usability.
